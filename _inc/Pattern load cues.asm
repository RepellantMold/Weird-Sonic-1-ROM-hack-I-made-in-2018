...
; ---------------------------------------------------------------------------
	...
	dc.w PLC_GHZ-ArtLoadCues, PLC_GHZ2-ArtLoadCues, PLC_GHZAnimals-ArtLoadCues
; ---------------------------------------------------------------------------
...
PLC_Main:	dc.w 4
		...
		dc.l Nem_Hud		; HUD
		dc.w $D940
		dc.l Nem_SonLives		; lives	counter
		dc.w $FA80
		dc.l Nem_Ring		; rings
		dc.w $F640
...
PLC_FZBoss:	dc.w 4
		...
		dc.w $A540
; ---------------------------------------------------------------------------
; Pattern load cues - hub world
; ---------------------------------------------------------------------------
PLC_HWZ:        dc.w $F
		dc.l Nem_HWZ	; GHZ main patterns
		dc.w 0
		dc.l Nem_Stalk		; flower stalk
		dc.w $6B00
		dc.l Nem_PplRock	; purple rock
