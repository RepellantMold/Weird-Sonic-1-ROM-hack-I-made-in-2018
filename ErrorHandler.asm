...
Str_ErrorHeader:
   dc.b   pal0,"Well the game crashed...", endl
   dc.b   "that's kinda awkward...anyway", endl, endl
   dc.b   pal3,"Send the following information", endl
   dc.b   "to ",pal2,"JS/S3DR",pal3,":",pal0,endl,endl
   dc.b   0
   even
...
ZeroDivide:
	__ErrorMessage "%<.l PtrStr_ErrorHeader str>ZERO DIVIDE", _eh_default

ChkInstr:
	__ErrorMessage "%<.l PtrStr_ErrorHeader str>CHK INSTRUCTION", _eh_default

TrapvInstr:
	__ErrorMessage "%<.l PtrStr_ErrorHeader str>TRAPV INSTRUCTION", _eh_default

PrivilegeViol:
	__ErrorMessage "%<.l PtrStr_ErrorHeader str>PRIVILEGE VIOLATION", _eh_default

Trace:
	__ErrorMessage "%<.l PtrStr_ErrorHeader str>TRACE", _eh_default

Line1010Emu:
	__ErrorMessage "%<.l PtrStr_ErrorHeader str>LINE 1010 EMULATOR", _eh_default

Line1111Emu:
	__ErrorMessage "%<.l PtrStr_ErrorHeader str>LINE 1111 EMULATOR", _eh_default

ErrorExcept:
	__ErrorMessage "%<.l PtrStr_ErrorHeader str>ERROR EXCEPTION", _eh_default
